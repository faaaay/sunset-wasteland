...
#define INSTITUTE		(1<<13)

#define F13EXECUTIVE (1<<0)
#define F13OPSCHIEF  (1<<1)
#define F13COURSER   (1<<2)
#define F13SCIENTIST (1<<3)
#define F13SYNTH     (1<<4)
...
#define JOB_DISPLAY_ORDER_EXECUTIVE 131
#define JOB_DISPLAY_ORDER_OPSCHIEF 132
#define JOB_DISPLAY_ORDER_COURSER 133
#define JOB_DISPLAY_ORDER_SCIENTIST 134
#define JOB_DISPLAY_ORDER_SYNTH 135
